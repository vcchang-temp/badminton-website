...
function initialize() {
	...
	// initialize badmintonPlaces

	badmintonPlaces = [richmondPro, clearOne, drive, stage18, ace, badmintonVancouver, 
...
/* LOAD DATA VARIABLES AND INITIALIZE BADMINTON PLACES GLOBAL VARIABLE UPON PAGE LOAD */
...
$("#submitButton").click(function() {
	...
	console.log(results); // to ensure it's the same as badminton places
